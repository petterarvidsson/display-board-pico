...
namespace action {
  ...
  public:
    ...
    void operator()(midi_bank_change_t b) {
      midi_message_t c1;
    ...
    void operator()(midi_nrpn_t nrpn) {
      midi_message_t message;
    ...
    void operator()(ymf262_slot_state_t s) {
    ...
    void operator()(action_ymf262_parameter_t c) {
    ...
    void operator()(ymf262_connection_t c) {
    ...
    void operator()(load_values_t load) {
      if (value.trigger) {
    ...
    void operator()(save_values_t save) {
      if (value.trigger) {
        const uint8_t patch = value.v1 & 0x7F;
  ...
  static void execute_actions(const tcb::span<const action_t> actions, action_value_t * action_values, int32_t * const values) {
    if(!actions.empty()) {
      uint8_t last_action;
  ...
  static int32_t parameter_value(const parameter_t parameter, const sdhi::sdhi_t sdhi, const int32_t * const values, const slots_t slots) {
    ...
    parameter.match(
        ...
        [&value, slots] (parameter_midi_note_t note) {
  ...
  static void update_computed_values(const tcb::span<const action_t> actions, const sdhi::sdhi_t sdhi, const int32_t * const values, const i2c_controller_button_t * const button, action_value_t * action_values, const slots_t slots) {
    for(uint8_t i = 0; i < actions.size(); i++) {
      actions[i].match(
                   ...
                   [i, action_values, sdhi, values, slots] (midi_bank_change_t bank_change) {
                     action_values[i].computed.v1 = parameter_value(bank_change.value, sdhi, values, slots);
                     action_values[i].computed.v2 = 0;
                     action_values[i].computed.v3 = 0;
                     action_values[i].computed.trigger = 0;
                   },
                   [i, action_values, sdhi, values, slots] (midi_rpn_t rpn) {
                   ...
                   [i, action_values, sdhi, values, slots] (midi_nrpn_t nrpn) {
                   ...
                   [i, action_values, sdhi, values, slots] (midi_mapping_t mapping) {
                   ...
                   [i, action_values, sdhi, values, slots] (slot_t slot) {
                     action_values[i].computed.v1 = parameter_value(slot.slot, sdhi, values, slots);
                     action_values[i].computed.v2 = 0;
                     action_values[i].computed.v3 = 0;
                   },
                   [i, action_values, sdhi, values, slots] (xg_parameter_change_1_t xg_parameter_change) {
                   ...
                   [i, action_values, sdhi, values, slots] (ymf262_slot_state_t ymf262_slot_state) {
                   ...
                   [i, action_values, sdhi, values, slots] (action_ymf262_parameter_t ymf262_parameter) {
                   ...
                   [i, action_values, sdhi, values, slots] (ymf262_connection_t connection) {
                     action_values[i].computed.v1 = parameter_value(connection.connection, sdhi, values, slots);
                     action_values[i].computed.v2 = 0;
                     action_values[i].computed.v3 = 0;
                     action_values[i].computed.trigger = 0;
                   },
                   [i, action_values, sdhi, values, slots, button] (load_values_t load) {
                   ...
                   [i, action_values, sdhi, values, slots, button] (save_values_t save) {
